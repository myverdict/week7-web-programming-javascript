...
console.log(furniture)  // { table: 'red', chair: 'blue', couch: 'green' }
console.log()


// Looping over all object properties
for (let f in furniture) {
    console.log(f);             // f is table, chair, couch - the property names
    console.log(furniture[f]);  // this is the value for each f property
    console.log()
}
...
if ("table" in furniture) {
    console.log("\nProperty 'table' is in the 'furniture' object.\n")
}
else {
    console.log("\n'table' is not in the 'furniture' object.\n")
}
...
let phoneData = phones[0]
console.log(phoneData)      // { os: 'Android', manufacturer: 'samsung' }
console.log()


for (let prop in phoneData) {
...
console.log('World Bank API: Complex JSON examples')
let countries_a = [
    {
        "id": "ABW",
        "iso2Code": "AW",
...
for (let i = 0; i < countries_a.length; i++) {
    let country = countries_a[i]
    console.log((i+1) + ') ' + country.name + ' has the 3-letter code ' + country.id + ' and the capital city is ' + country.capitalCity + '.')
}
console.log();
...
for (let component in random_taco) {
